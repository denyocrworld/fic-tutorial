// dart lib\tutorial\latihan2.dart
// nodemon --exec dart lib\tutorial\latihan2.dart
...
void main() {
  ...
  //1. print product_name dan price di dalam List yang harga-nya lebih dari 30 (gunakan for(var i=0, ...))
}
